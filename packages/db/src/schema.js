...
export const openTradeStatuses = ["planned", "open", "closing"];
export const tradeLegSides = ["long", "short"];
...
export const trades = mysqlTable(
    "trades",
    {
        ...
        shortExchange: varchar("short_exchange", { length: 32 }).notNull(),
        leverage: int("leverage").notNull(),
        entrySpreadUsd: decimal("entry_spread_usd", {
            precision: 24,
            scale: 8,
        }),
        exitSpreadUsd: decimal("exit_spread_usd", { precision: 24, scale: 8 }),
        realizedPnlUsd: decimal("realized_pnl_usd", {
            precision: 24,
            scale: 8,
        }),
...
export const tradeStatusHistory = mysqlTable(
    ...
    (table) => ({
        tradeChangedAtIdx: index(
            "trade_status_history_trade_changed_at_idx",
        ).on(table.tradeId, table.changedAt),
...
export const telegramCommandLogs = mysqlTable(
    ...
    (table) => ({
        ...
        commandCreatedAtIdx: index(
            "telegram_command_command_created_at_idx",
        ).on(table.command, table.createdAt),
    }),
);
